...
RSpec.describe EventsController, type: :controller do
    before do
        ...
        @event = Event.create!(title: "test_events",producer_id:@admin._id.to_str,status:"ACCEPTING",form_id:@form._id.to_str)
        ...
        @slide = Slide.create(event_id:@event._id,talent_id:@talent._id,curated:false,submission_status:"UNDER REVIEW",data:"{\"name\":\"aaaa\",\"email\":\"aaaa@gmail.com\",\"talentName\":\"aaaa\",\"state\":\"Kentucky\",\"city\":\"Ames\",\"paymentLink\":\"paypal.me/random\"}")
